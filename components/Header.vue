...
<nav class="bg-white border-gray-200 dark:bg-[#005EB8]">
  ...
  <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Fucked" />
  </a>
  <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      <a class="text-white max-sm:hidden font-medium pr-4 content-center items-center mx-auto justify-between ">My Account</a>
  ...
  <div class="text-white items-center justify-center hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
    <span class="self-center text-2xl font-semibold ">Doctors On Hand</span>

    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 rtl:space-x-reverse md:flex-row md:mt-0 justify-centre">
       <!-- <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white ">Doctors On Hand</span>-->
