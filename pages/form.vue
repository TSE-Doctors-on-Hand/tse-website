<template>
    ...
    <form @submit.prevent="submitForm">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="symptom-duration" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter duration" required>
        </div>
        <div class="mb-6">
            ...
            <label for="checkbox1" class="ms-2 text-sm font-medium text-gray-900 dark:text-black-300">Are you at home?</label>
        </div>
        <div class="mb-6">
