    ...
    <li>
        <details class="group">
            <summary class="flex items-center gap-3 px-4 py-3 font-medium marker:content-none hover:cursor-pointer">
                ...
                <span>What is doctors on hand?</span>
            </summary>
    ...
    <li>
        <details class="group">
            <summary class="flex items-center gap-3 px-4 py-3 font-medium marker:content-none hover:cursor-pointer">
                ...
                <span>Will save my information?</span>
            </summary>
    ...
    <li>
        <details class="group">
            <summary class="flex items-center gap-3 px-4 py-3 font-medium marker:content-none hover:cursor-pointer">
                ...
                <span>Why does the nigerian prince not reply after i sent him the £300 to fix his broken leg</span>
            </summary>
    ...
    <li>
        <details class="group">
            <summary class="flex items-center gap-3 px-4 py-3 font-medium marker:content-none hover:cursor-pointer">
                ...
                <span>Multiple lengths of symptoms?</span>
            </summary>
